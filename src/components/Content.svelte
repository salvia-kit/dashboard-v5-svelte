...
<div class="flex flex-col flex-wrap sm:flex-row">
		...
		>
			<div class="bg-white dark:bg-gray-800 px-6 py-8 lg:flex-shrink-1 lg:p-12">
				...
				<p class="mt-6 text-base leading-6 text-gray-500 dark:text-gray-200">
					Start selling online for free with all the features you need to launch your local delivery
					and pick-up service, nothing more. We don&#x27;t charge commission or monthly fees, keep
					all your margin.
				</p>
				<div class="mt-8">
					...
					<ul class="mt-8 lg:grid lg:grid-cols-2 lg:col-gap-8 lg:row-gap-5">
						...
						<li class="flex items-start lg:col-span-1">
							...
							<p class="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">Best ranking</p>
						</li>
						<li class="flex items-start lg:col-span-1">
							<div class="flex-shrink-0">
								<svg
							...
							<p class="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">Premium svg</p>
						</li>
						<li class="flex items-start lg:col-span-1">
							<div class="flex-shrink-0">
								<svg
							...
							<p class="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">My wife</p>
						</li>
					</ul>
				</div>
				<div class="mt-8">
			...
			<div
				class="py-8 px-6 text-center bg-white lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12"
			>
				<p class="text-lg leading-6 font-bold text-gray-900 dark:text-white">Free</p>
				<div
				...
				<p class="mt-4 text-sm leading-5">
					<span class="block font-medium text-gray-500 dark:text-gray-400"> Card payments: </span>
	...
	<div class="w-full md:w-4/12 md:px-2 mb-6 md:mb-0">
		<div class="shadow-lg rounded-2xl bg-white dark:bg-gray-800 p-4">
			<p class="text-gray-800 dark:text-gray-50 text-xl font-medium mb-4">Entreprise</p>
	...
	<div class="w-full md:w-4/12 md:px-2  mb-6 md:mb-0">
		<div class="shadow-lg rounded-2xl bg-white dark:bg-gray-800 p-4">
			<p class="text-black dark:text-white text-3xl font-bold">Pay as you go</p>
			<p class="text-gray-500 dark:text-gray-300 text-sm mb-4">For the basics tailwind</p>
			<p class="text-black dark:text-white  text-3xl font-bold">$99</p>
			<p class="text-gray-500 dark:text-gray-300 text-sm mb-4">Per agent per month</p>
			<button
				type="button"
